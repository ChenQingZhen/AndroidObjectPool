Android官网的最佳实践（best praties）中的对象池使用，实现方式是基于v4包的SynchronizedPool，这是官网API和Demo的地址： https://developer.android.com/reference/android/support/v4/util/Pools.html 这个项目的对象池技术是基于v4包的SynchronizedPool
